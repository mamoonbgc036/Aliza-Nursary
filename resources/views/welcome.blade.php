                ...
                <div class="alazea-service-area mb-100">
                    ...
                    <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="service-icon mr-30">
                            <img src="{{asset('assets/frontend/img/core-img/s1.png')}}" alt="">
                        </div>
                        <!-- Content -->
                    ...
                    <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="300ms">
                        <!-- Icon -->
                        <div class="service-icon mr-30">
                            <img src="{{asset('assets/frontend/img/core-img/s2.png')}}" alt="">
                        </div>
                        <!-- Content -->
                        <div class="service-content">
                    ...
                    <div class="single-service-area d-flex align-items-center wow fadeInUp" data-wow-delay="500ms">
                        <!-- Icon -->
                        <div class="service-icon mr-30">
                            <img src="{{asset('assets/frontend/img/core-img/s3.png')}}" alt="">
                        </div>
                        <!-- Content -->
                        <div class="service-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="single-benefits-area">
                                <img src="{{asset('assets/frontend/img/core-img/b1.png')}}" alt="">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="single-benefits-area">
                                <img src="{{asset('assets/frontend/img/core-img/b2.png')}}" alt="">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="single-benefits-area">
                                <img src="{{asset('assets/frontend/img/core-img/b3.png')}}" alt="">
                                <h5>100% Natural</h5>
                                <p>Intiam eu sagittis est, at commodo lacini libero. Praesent dignissim sed odio vel
                                    aliquam manta lagorn.</p>
                            </div>
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="single-benefits-area">
                                <img src="{{asset('assets/frontend/img/core-img/b4.png')}}" alt="">
        ...
        <div class="row alazea-portfolio">
            ...
            <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item design home-design wow fadeInUp"
                ...
                <div class="portfolio-thumbnail bg-img"
                    style="background-image: url({{asset('assets/frontend/img/bg-img/16.jpg')}});"></div>
                <!-- Portfolio Hover Text -->
                <div class="portfolio-hover-overlay">
                    <a href="{{asset('assets/frontend/img/bg-img/16.jpg')}}"
            ...
            <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden wow fadeInUp" data-wow-delay="200ms">
                <!-- Portfolio Thumbnail -->
                <div class="portfolio-thumbnail bg-img"
                    style="background-image: url({{asset('assets/frontend/img/bg-img/17.jpg')}});"></div>
                <!-- Portfolio Hover Text -->
                <div class="portfolio-hover-overlay">
                    <a href="{{asset('assets/frontend/img/bg-img/17.jpg')}}"
            ...
            <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden design wow fadeInUp"
                ...
                <!-- Portfolio Thumbnail -->
                <div class="portfolio-thumbnail bg-img"
                    style="background-image: url({{asset('assets/frontend/img/bg-img/18.jpg')}});"></div>
                <!-- Portfolio Hover Text -->
                <div class="portfolio-hover-overlay">
                    <a href="{{asset('assets/frontend/img/bg-img/18.jpg')}}"
            ...
            <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden office-design wow fadeInUp"
                ...
                <!-- Portfolio Thumbnail -->
                <div class="portfolio-thumbnail bg-img"
                    style="background-image: url({{asset('assets/frontend/img/bg-img/19.jpg')}});"></div>
                <!-- Portfolio Hover Text -->
                <div class="portfolio-hover-overlay">
                    <a href="{{asset('assets/frontend/img/bg-img/19.jpg')}}"
            ...
            <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item design office-design wow fadeInUp"
                ...
                <!-- Portfolio Thumbnail -->
                <div class="portfolio-thumbnail bg-img"
                    style="background-image: url({{asset('assets/frontend/img/bg-img/20.jpg')}});"></div>
                <!-- Portfolio Hover Text -->
                <div class="portfolio-hover-overlay">
                    <a href="{{asset('assets/frontend/img/bg-img/20.jpg')}}"
            ...
            <div class="col-12 col-sm-6 col-lg-3 single_portfolio_item garden wow fadeInUp" data-wow-delay="200ms">
                <!-- Portfolio Thumbnail -->
                <div class="portfolio-thumbnail bg-img"
                    style="background-image: url({{asset('assets/frontend/img/bg-img/21.jpg')}});"></div>
                <!-- Portfolio Hover Text -->
                <div class="portfolio-hover-overlay">
                    <a href="{{asset('assets/frontend/img/bg-img/21.jpg')}}"
            ...
            <div class="col-12 col-lg-6 single_portfolio_item home-design wow fadeInUp" data-wow-delay="300ms">
                <!-- Portfolio Thumbnail -->
                <div class="portfolio-thumbnail bg-img"
                    style="background-image: url({{asset('assets/frontend/img/bg-img/22.jpg')}});"></div>
                <!-- Portfolio Hover Text -->
                <div class="portfolio-hover-overlay">
                    <a href="{{asset('assets/frontend/img/bg-img/22.jpg')}}"
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-blog-post mb-100">
                    <div class="post-thumbnail mb-30">
                        <a href="single-post.html"><img src="{{asset('assets/frontend/img/bg-img/6.jpg')}}" alt=""></a>
                    </div>
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-blog-post mb-100">
                    <div class="post-thumbnail mb-30">
                        <a href="single-post.html"><img src="{{asset('assets/frontend/img/bg-img/7.jpg')}}" alt=""></a>
                    </div>
                    <div class="post-content">
                        <a href="single-post.html" class="post-title">
            ...
            <div class="col-12 col-md-6 col-lg-4">
                <div class="single-blog-post mb-100">
                    <div class="post-thumbnail mb-30">
                        <a href="single-post.html"><img src="{{asset('assets/frontend/img/bg-img/8.jpg')}}" alt=""></a>
                    </div>
                    <div class="post-content">
                        <a href="single-post.html" class="post-title">
...
<section class="subscribe-newsletter-area"
    style="background-image: url({{asset('assets/frontend/img/bg-img/subscribe.png')}});">
    <div class="container">
    ...
    <div class="subscribe-side-thumb wow fadeInUp" data-wow-delay="500ms">
        <img class="first-img" src="{{asset('assets/frontend/img/core-img/leaf.png')}}" alt="">
    </div>
</section>
<!-- ##### Subscribe Area End ##### -->
